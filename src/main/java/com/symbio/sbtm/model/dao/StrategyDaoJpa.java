...
@Repository(value = "strategyDao")
public class StrategyDaoJpa implements StrategyDao {
	private static final Logger logger = Logger.getLogger(StrategyDaoJpa.class.getName());
