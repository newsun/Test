...
description varchar(250),
foreign key(roleId) references Role(id) on delete no action on update cascade
);
...
foreign key(roleId) references User(id) on delete no action on update cascade
);
...
insert into role(name,description) values("mana","Project Manager");
insert into role(name,description) values("tester","Tester");

/***************************************************************************
 *  step2: insert entries into user table
 ***************************************************************************/
insert into user(userId,password,name,roleId,description,valid) values("admin","admin","Administrator",1,"test only",true);
insert into user(userId,password,name,roleId,description,valid) values("johnny","johnny","johnny depp",2,"test only",true);
insert into user(userId,password,name,roleId,description,valid) values("user","user","User",3,"test only",true);
insert into user(userId,password,name,roleId,description,valid) values("james","james","james bond",3,"test only",true);
