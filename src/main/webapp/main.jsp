...
var url=window.location.toString().match(/([^\/]+)\.html$/g)[0];
console.log(url);
$("[href='"+url+"']").class="active";
</script>
<decorator:head />
</head>
<body>
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html">Symbio <span>SBTM </span><small>Session Base Testing Management</small></a></h1>
      </div>
      <div class="search">
  ...
  <div class="footer">
    <div class="footer_resize">
      <p class="lf">© Copyright <a href="#">Symbio - Serious About Software</a>.</p>
      <p class="rf"><a href="http://www.symbio.com/" title="Symbio Quality Assurance">Symbio Quality Assurance</a></p>
      <div class="clr"></div>
    </div>
  </div>
</div>
