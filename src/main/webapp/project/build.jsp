...
<body>
	<div class="entrybar">
		<ul class="vertical tabs">
			...
			<li class=" "><a hidefocus=""
				href="#"
				id="labels-heatmap-panel-panel" class="browse-tab"><strong>Labels</strong>
			</a></li>
		</ul>
	</div>
	<div class="mainbar">
							...
							<div class="aui-list hidden">
								<ul class="aui-list-section aui-last" id="reports-dropdown">
									<li class="aui-list-item"><a
										...
										href="#"
										class="aui-list-item-link">User Workload Report</a>
									</li>
									<li class="aui-list-item"><a
										...
										href="#"
										class="aui-list-item-link">Version Workload Report</a>
									</li>
									<li class="aui-list-item"><a
										title="This report shows the time tracking details for a specific project."
										href="#"
										class="aui-list-item-link">Time Tracking Report</a>
									</li>
									<li class="aui-list-item"><a
										title="This report allows you to display issues grouped by a certain field"
										href="#"
										class="aui-list-item-link">Single Level Group By Report</a>
									</li>
									<li class="aui-list-item"><a
									...
									<li class="aui-list-item"><a
										...
										href="#"
										class="aui-list-item-link">Time Since Issues Report</a>
									</li>
								</ul>
							</div>
						</li>
						<li class="aui-dd-parent"><a id="filters"
							...
							<div class="aui-list hidden">
								<ul class="aui-list-section aui-last" id="filters-dropdown">
									<li class="aui-list-item"><a
										href="#"
										id="filter_all" class="aui-list-item-link">All</a></li>
									<li class="aui-list-item"><a
										href="#"
							...
							<div class="mod-content">
								<ul class="issues">
									<li class="vevent"><img height="16" width="16"
										...
										href="#" class="url issue summary">BAIDU-1</a> <span
									...
									<li class="vevent"><img height="16" width="16"
										title="Task - A task that needs to be done."
										src="/images/task.gif" alt="Task"> <a
										href="#" class="url issue summary">BAIDU-2</a> <span
									...
									<li class="vevent"><img height="16" width="16"
										title="Task - A task that needs to be done."
										src="/images/task.gif" alt="Task"> <a
										href="#" class="url issue summary">BAIDU-3</a> <span
						...
						<div id="fragcreatedvsresolved" class="module">
							...
							<div class="mod-content">
								<img height="250" width="380" border="0" usemap="\#chart-SLm67"
									src="chart/ListAllFruit4Pie2.action"><br> Issues: <b><span
