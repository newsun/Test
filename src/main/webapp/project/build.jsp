		...
		<div class="entrybar">
			<ul class="vertical tabs">
				...
				<li class=" "><a hidefocus="" href="#" id="issues-panel-panel"
					class="browse-tab"><strong>Issues</strong> </a>
				</li>
			...
			<div data-project-key="BAIDU" id="project-tab" class="active-area">
							...
							<div class="aui-list hidden">
								<ul class="aui-list-section aui-last" id="reports-dropdown">
									<li class="aui-list-item"><a
										...
										href="#" class="aui-list-item-link">User Workload Report</a></li>
									<li class="aui-list-item"><a
									...
									<li class="aui-list-item"><a
										...
										href="#" class="aui-list-item-link">Time Tracking Report</a></li>
									<li class="aui-list-item"><a
									...
									<li class="aui-list-item"><a
										...
										href="#" class="aui-list-item-link">Pie Chart Report</a></li>
									<li class="aui-list-item"><a
										title="A report showing the average age of unresolved issues for a project or filter."
										href="#" class="aui-list-item-link">Average Age Report</a></li>
									<li class="aui-list-item"><a
							...
							<div class="aui-list hidden">
								<ul class="aui-list-section aui-last" id="filters-dropdown">
									<li class="aui-list-item"><a href="#" id="filter_all"
										class="aui-list-item-link">All</a>
									</li>
							...
							<div class="mod-header">
								<ul class="ops">
									<li><a title="" href="#" class="icon icon-view"
										id="fragdueissues_more"><span>More</span> </a></li>
								</ul>
								<h3>Issues: Due</h3>
							</div>
							<div class="mod-content">
								<ul class="issues">
									<li class="vevent"><img height="16" width="16"
										...
										src="/images/task.gif" alt="Task"> <a href="#"
										class="url issue summary">BAIDU-1</a> <span
									...
									<li class="vevent"><img height="16" width="16"
										title="Task - A task that needs to be done."
										src="/images/task.gif" alt="Task"> <a href="#"
										class="url issue summary">BAIDU-2</a> <span
									...
									<li class="vevent"><img height="16" width="16"
										title="Task - A task that needs to be done."
										src="/images/task.gif" alt="Task"> <a href="#"
										class="url issue summary">BAIDU-3</a> <span
						...
						<div id="fragcreatedvsresolved" class="module">
							...
							<div class="mod-content">
								<img height="250" width="380" border="0" usemap="\#chart-SLm67"
									src="chart/ListAllFruit4Pie2"><br> Issues: <b><span
				...
				<div id="fragrecentissues" class="module">
					<div class="mod-header">
						<ul class="ops">
							<li><a title="" href="#" class="icon icon-view"
								id="fragrecentissues_more"><span>More</span> </a></li>
						</ul>
