...
<body>
	<div class="entrybar">
		<ul class="vertical tabs">
			<li class="active  first"><a hidefocus=""
				href="#"
				id="summary-panel-panel" class="browse-tab"><strong>Summary</strong>
			</a>
			</li>
			<li class=" "><a hidefocus=""
				href="#"
				id="issues-panel-panel" class="browse-tab"><strong>Issues</strong>
			</a>
			</li>
			...
			<li class=" "><a hidefocus=""
				href="#"
				id="popularissues-panel-panel" class="browse-tab"><strong>Popular
						Issues</strong> </a>
			</li>
							...
							<div class="aui-list hidden">
								<ul class="aui-list-section aui-last" id="reports-dropdown">
									<li class="aui-list-item"><a
										...
										href="#"
										class="aui-list-item-link">User Workload Report</a></li>
									<li class="aui-list-item"><a
						...
						<li class="aui-dd-parent"><a id="filters"
							...
							<div class="aui-list hidden">
								<ul class="aui-list-section aui-last" id="filters-dropdown">
									<li class="aui-list-item"><a
										href="#"
										id="filter_all" class="aui-list-item-link">All</a>
									</li>
									<li class="aui-list-item"><a
										href="#"
								...
								<ul class="item-details">
									<li>
										...
										<dl>
											...
											<dd>
												<a href="#"
													id="project_summary_junling.liu" rel="junling.liu"
													class="user-hover">Junling Liu</a>
											</dd>
										</dl>
										<dl>
											<dt>Key:</dt>
						...
						<div id="fragdueissues" class="module">
							<div class="mod-header">
								<ul class="ops">
									<li><a title=""
										href="#"
										class="icon icon-view" id="fragdueissues_more"><span>More</span>
									</a></li>
								</ul>
								<h3>Issues: Due</h3>
							</div>
							<div class="mod-content">
								<ul class="issues">
									<li class="vevent"><img height="16" width="16"
										...
										href="#">BAIDU-1</a> <span
										class="dtstart hidden">2012-10-08T07-30</span> <span
										class="dtend hidden">2012-10-08T19-30</span> <span
										class="description">requirement analysis</span>
									</li>
									<li class="vevent"><img height="16" width="16"
										title="Task - A task that needs to be done."
										src="/images/task.gif" alt="Task"> <a
										href="#">BAIDU-2</a> <span
										class="dtstart hidden">2012-10-12T07-06</span> <span
										class="dtend hidden">2012-11-01T12-07</span> <span
										class="description">bug fixing</span>
									</li>
									<li class="vevent"><img height="16" width="16"
										title="Task - A task that needs to be done."
										src="/images/task.gif" alt="Task"> <a
										href="#">BAIDU-3</a> <span
										class="dtstart hidden">2012-10-12T09-00</span> <span
										class="dtend hidden">2012-12-26T04-32</span> <span
										class="description">Frontend work</span>
									</li>
								</ul>
							</div>
						</div>
				...
				<div id="fragrecentissues" class="module">
					<div class="mod-header">
						<ul class="ops">
							<li><a title=""
								href="#"
								class="icon icon-view" id="fragrecentissues_more"><span>More</span>
							</a></li>
						</ul>
						...
						<ul class="issues">
							<li class="vevent"><img height="16" width="16"
								...
								class="date"><abbr title="2013-01-11T05-25" class="dtend">Yesterday
										05:25:54</abbr> </span> <span class="description">Test</span>
							</li>
							<li class="vevent"><img height="16" width="16"
								title="Task - A task that needs to be done."
								src="/images/task.gif" alt="Task"> <a
							...
							</span> <span class="description">Project Management</span>
							</li>
							<li class="vevent"><img height="16" width="16"
								title="Task - A task that needs to be done."
								src="/images/task.gif" alt="Task"> <a
							...
							</span> <span class="description">Virtual machine cloning</span>
							</li>
						</ul>
					</div>
				</div>
