...
<body>
	<s:div id="charterSummary" class="charterSummary">
		<h3>
			Charter:
		...
		<table>
			<tbody>
				...
				<tr>
					<td>Start Time</td>
					<td><s:textfield name="charter.starttime"></s:textfield></td>
				</tr>
				<tr>
					<td>Tester</td>
					<td><s:textfield name="charter.tester.name"></s:textfield></td>
				</tr>
			</tbody>
		</table>
	</s:div>
	...
	<s:div id="breakdown">
		...
		<table>
			<tbody>
				...
				<tr>
					<td>SET UP</td>
					<td><s:textfield name="charter.sesstionSetup"></s:textfield></td>
				</tr>

				<tr>
					<td>CHARTER VS. OPP</td>
					<td><s:textfield name="charter.chartervsopp"></s:textfield></td>
				</tr>
			</tbody>
		</table>
	</s:div>
		...
		<s:iterator value="charter.bugs" id="bug" status="st">
			<table id="bug<s:property value='#st.index' />">
				<tbody>
					...
					<tr>
						<td>Description</td>
						<td><s:textarea name="description" label="Description"></s:textarea>
						</td>
					</tr>
					<tr>
						<td></td>
		...
		<table>
			<tbody>
				<s:iterator value="charter.issues">
					...
					<tr>
						<td><s:textarea name="charter.issues"></s:textarea></td>
					</tr>
				</s:iterator>
			</tbody>
		</table>
